(async function(){
    ...
    class WeatherDataItem extends HTMLElement {
        ...
        static _itemName = (() => {
            return {
                ...
                "PoP": {
                    "zh-TW": "降雨機率：",
                    "en-US": "Probability of precipitation: "
                },
                "MinT": {
                    "zh-TW": "最低氣溫：",
                    "en-US": "Minimum Temperature: "
                },
                "MaxT": {
                    "zh-TW": "最高氣溫：",
                    "en-US": "Maximum Temperature: "
                },
                "CI": {
                    "zh-TW": "舒適度：",
                    "en-US": "Comfort Index: "
            ...
            this.innerHTML = `
                ...
                <div class="time-slot">
                    ...
                    <ul class="weather-data-list">
                        ...
                        <li class="weather-data-item MinT"><span class="data-title">${WeatherDataItem._itemName.MinT[lang]}</span><span class="data-shower">${slot.weather.MinT.parameterName}&nbsp;&#8451;</span></li>
                        <li class="weather-data-item MaxT"><span class="data-title">${WeatherDataItem._itemName.MaxT[lang]}</span><span class="data-shower">${slot.weather.MaxT.parameterName}&nbsp;&#8451;</span></li>
                        <li class="weather-data-item CI"><span class="data-title">${WeatherDataItem._itemName.CI[lang]}</span><span class="data-shower">${slot.weather.CI.parameterName}</span></li>
                    </ul>
                </div>
            `
        }
    ...
    const parseLocation = (location, lang) => {
        const timeMap = {}
        ...
        return `<div class="location">
            ...
            ${timeSlots.map(slot => {
                return `<weather-data-item lang="${lang}">
    ...
    try {
        if (weatherDataZh) {
            ...
            var content = weatherDataZh.records.location.map((location) => parseLocation(location, "zh-TW")).join('')
